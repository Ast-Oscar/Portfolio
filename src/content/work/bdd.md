...
We decided to use a **WebApplication Framework** for the graphical interface of the 
information system of Mr. Bellefleur (the given name of the salesman manager) and for the interface of customers. We therefore use **ASP.NET** **WebForms** to give the overall structure of each page and to integrate the C# code behind.
